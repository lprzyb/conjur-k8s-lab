...
CONJUR_LEADER_URL=https://$CONJUR_LEADER_HOST
AUTHENTICATOR_ID=k8s
CONJUR_ACCOUNT=$LAB_CONJUR_ACCOUNT
CONJUR_SEED_FILE_URL=$CONJUR_LEADER_URL/configuration/$CONJUR_ACCOUNT/seed/follower
...
kubectl -n conjur create configmap follower-cm \
    ...
    --from-literal CONJUR_APPLIANCE_URL=$CONJUR_LEADER_URL \
